...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { answer_id: @option.answer_id, choose_value: @option.choose_value } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { answer_id: @option.answer_id, choose_value: @option.choose_value } }
